...
$$
log(Pop) = \beta_1 \cdot Size + \beta_2 \cdot Resid + \beta_3 \cdot Commerce + \beta_4 \cdot Green + \beta_5 \cdot Density + \beta_6 \cdot Arrival +
\beta_7 \cdot Fine + \beta_8 \cdot Hyper + \beta_0 + \epsilon
$$
...
이 경우 역시 오차 역시 2.5%로 상당히 잘 예측하고 있음
