...
- 과연 미세먼지가 많은 날 사람들이 백화점을 더 많이 방문할까?

- 얼마나 더 많은 사람들이 백화점을 방문할까?
...
- 배제 기준: 대중교통시설 포함 집계구 (기차, 공항, 버스)
- 하나의 집계구에 여러 백화점이 있는 경우는 연면적 등 합산
- 최종 분석 대상: 16개소 식별
...
- WHO 미세먼지 8단계 기준, 미세먼지 혹은 초미세먼지 5단계 (나쁨) 이상이면 먼지 많은 날로 정의
